...
DocumentReference? get currentUserReference =>
    loggedIn ? ProfileCreationRecord.collection.doc(currentUser!.uid) : null;

ProfileCreationRecord? currentUserDocument;
final authenticatedUserStream = FirebaseAuth.instance
    ...
    .switchMap(
      (uid) => uid.isEmpty
          ? Stream.value(null)
          : ProfileCreationRecord.getDocument(
                  ProfileCreationRecord.collection.doc(uid))
              .handleError((_) {}),
    )
    .map((user) {
