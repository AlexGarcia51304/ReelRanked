          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                          ...
                          itemBuilder: (context, followersIndex) {
                            ...
                            return StreamBuilder<ProfileCreationRecord>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                final containerProfileCreationRecord =
                                    snapshot.data!;
                                ...
                                return Container(
                                  ...
                                  child: InkWell(
                                    ...
                                    onTap: () async {
                                      logFirebaseEvent(
                                          'FOLLOWING_PAGE_Row_ja0toiep_ON_TAP');
                                      ...
                                      context.pushNamed(
                                        ...
                                        queryParameters: {
                                          'friendRef': serializeParam(
                                            containerProfileCreationRecord
                                                .reference,
                                      ...
                                      children: [
                                        Column(
                                          ...
                                          children: [
                                            ...
                                            Text(
                                              '@${containerProfileCreationRecord.username}',
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .labelMedium
                                                      .override(
                ...
                FFButtonWidget(
                  onPressed: () async {
                    logFirebaseEvent('FOLLOWING_PAGE_profileButton_ON_TAP');
