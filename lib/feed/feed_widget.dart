...
import '/components/feed_review_card_widget.dart';
                ...
                children: [
                  Padding(
                    ...
                    child: AuthUserStreamWidget(
                      builder: (context) => StreamBuilder<List<ReviewsRecord>>(
                        stream: queryReviewsRecord(
                          queryBuilder: (reviewsRecord) =>
                              reviewsRecord.whereIn(
                                  'user',
                        ...
                        builder: (context, snapshot) {
                          ...
                          return ListView.builder(
                            ...
                            itemBuilder: (context, listViewIndex) {
                              ...
                              return FeedReviewCardWidget(
                                key: Key(
                                    'Key5w6_${listViewIndex}_of_${listViewReviewsRecordList.length}'),
