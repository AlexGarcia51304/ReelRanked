                          ...
                          Stack(
                            children: [
                              FFButtonWidget(
                                onPressed: () async {
                                  logFirebaseEvent(
                                      'PROFILE_PAGE_PAGE_findFriends_ON_TAP');
                                  logFirebaseEvent('findFriends_navigate_to');

                                  context.pushNamed(
                                      FriendsSearchPageWidget.routeName);
                                },
                                text: 'Find Friends',
                                        ...
                                        children: [
                                          AuthUserStreamWidget(
                                            builder: (context) => InkWell(
                                              ...
                                              onTap: () async {
                                                logFirebaseEvent(
                                                    'PROFILE_PAGE_PAGE_Text_jppkg49c_ON_TAP');
                                                logFirebaseEvent(
                                                    'Text_navigate_to');
                                        ...
                                        children: [
                                          AuthUserStreamWidget(
                                            builder: (context) => InkWell(
                                              ...
                                              onTap: () async {
                                                logFirebaseEvent(
                                                    'PROFILE_PAGE_PAGE_Text_rm7dniun_ON_TAP');
                                                logFirebaseEvent(
                                                    'Text_navigate_to');
                                        ...
                                        return ListView.builder(
                                          ...
                                          itemBuilder:
                                            ...
                                            return ReviewCardWidget(
                                              key: Key(
                                                  'Keyo3a_${listViewIndex}_of_${listViewReviewsRecordList.length}'),
                                              reviews: listViewReviewsRecord,
                                            );
                                          },
                                        );
                                      },
