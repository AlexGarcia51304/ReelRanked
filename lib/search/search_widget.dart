                  ...
                  child: Container(
                    ...
                    child: TextFormField(
                      ...
                      onChanged: (_) => EasyDebounce.debounce(
                        ...
                        () async {
                          logFirebaseEvent(
                              'SEARCH_searchBox_ON_TEXTFIELD_CHANGE');
                          logFirebaseEvent('searchBox_backend_call');
                          _model.apiResult9dl =
                              await SearchMoviesAndShowsCall.call(
                            query: _model.searchBoxTextController.text,
                          );

                          if ((_model.apiResult9dl?.succeeded ?? true)) {
                            logFirebaseEvent('searchBox_update_app_state');
                      ...
                      decoration: InputDecoration(
                        ...
                        hintText: 'Search any Movie, Show, etc...',
                        hintStyle:
                            FlutterFlowTheme.of(context).labelMedium.override(
                                  font: GoogleFonts.inter(
                                    fontWeight: FlutterFlowTheme.of(context)
